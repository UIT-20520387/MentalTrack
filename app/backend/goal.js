...
async function loadGoals(uid) {
  ...
  try {
    ...
    showMessage(
      "Không thể tải mục tiêu. Vui lòng kiểm tra kết nối hoặc quyền truy cập.",
      "goalMessage"
    );
  }
}
...
async function addGoal() {
  ...
  try {
    ...
    showMessage(
      "Có lỗi xảy ra khi thêm mục tiêu. Vui lòng thử lại.",
      "goalMessage"
    );
  }
}
...
async function deleteGoal(goalId) {
  ...
  try {
    ...
    showMessage(
      "Có lỗi xảy ra khi xóa mục tiêu. Vui lòng thử lại.",
      "goalMessage"
    );
  }
}
